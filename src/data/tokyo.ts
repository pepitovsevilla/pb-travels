...
export const tokyoDays: TokyoDay[] = [
    ...
    timeline: [
      {
        ...
        title: "What you did",
        bullets: [
          "Checked in early, then Pepito worked in the morning.",
          "Lunch at Vegan Bistro Jangara.",
          "Walked around Shibuya and bought I’m donut? donuts.",
          "Dinner at Masaka.",
        ],
      },
    ],
    ...
    timeline: [
      {
        ...
        title: "What you did",
        bullets: [
          "Pepito worked in the morning. Bianca completed the ASICS run.",
          "Lunch at AIN SOPH. Journey.",
          "Walked in Shinjuku and bought dessert from marbre vegan.",
          "Dinner at Zen.",
        ],
      },
    ],
  },
  {
    ...
    shortDate: "Aug 8",
    subtitle: "Asakusa food day and Skytree izakaya",
    area: "Ueno · Asakusa · Skytree",
    status: "current",
    ...
    timeline: [
      {
        label: "Before lunch",
        icon: "dessert",
        title: "Savor the Matcha",
        description: "Start in Ueno. It opens at 11:00 AM.",
        links: [maps("Open in Maps", "Savor the Matcha Ueno")],
      },
      {
        label: "Before lunch",
        icon: "walk",
        title: "Asakusa",
        description: "Walk Kaminarimon, Nakamise, Senso-ji, and Asakusa Shrine.",
        links: [
      ...
      },
      {
        ...
        description: "See Senso-ji and Skytree from the Culture Tourist Information Center, then reset at the hotel if you want.",
  ...
  },
  {
    ...
    shortDate: "Aug 9",
    subtitle: "Shimokitazawa pastries, Tomigaya lunch, and CEO dinner",
    area: "Shimokitazawa · Tomigaya · hotel reset · Kioicho",
    ...
    timeline: [
      ...
      },
      {
        ...
        callout: "Aim for 12:30 PM. Indoor seating is limited.",
  ...
  },
  {
    ...
    shortDate: "Aug 11",
    subtitle: "Mountain Day · Ginza lunch and a Jikasei dinner mission",
    area: "Ginza · hotel reset · Shibuya",
    ...
    timeline: [
      {
        ...
        icon: "cool",
        title: "Ginza indoors",
        description: "Use Ginza Mitsukoshi, GINZA SIX, or Ginza Loft to stay cool before lunch.",
      },
      {
        label: "Lunch",
        icon: "meal",
        tone: "meal",
        title: "KOMEDA is ☐",
        description: "Fully plant-based food in Higashi-Ginza—not a breakfast stop.",
        callout: "The full menu runs until 9:30 PM.",
        links: [maps("Open in Maps", "KOMEDA is Higashi Ginza")],
      },
      {
        label: "After lunch",
        icon: "dessert",
        title: "Ginza sweets",
        bullets: [
          "AIN SOPH. Ginza for pudding, tiramisu, or raisin sandwiches.",
          "Marshmallooow in Ginza Mitsukoshi B2.",
          "Ginza Tsuboyaki-imo for roasted sweet potato.",
        ],
        links: [
          maps("AIN SOPH. Ginza", "AIN SOPH. Ginza"),
          maps("Marshmallooow", "The Vegan Marshmallooow Ginza"),
  ...
  },
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: "Vegan tsukemen near Suidobashi.",
        callout: "Check its Instagram before leaving. If it is closed, use T’s Tantan Ueno.",
        links: [
          maps("Tsukemen Zuppa", "Tsukemen Zuppa Suidobashi"),
