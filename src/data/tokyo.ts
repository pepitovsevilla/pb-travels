...
export const tokyoDays: TokyoDay[] = [
  ...
  },
  {
    ...
    shortDate: "Aug 8",
    subtitle: "Shimokitazawa, Harajuku, Meiji Jingu, and Skytree izakaya",
    area: "Shimokitazawa · Harajuku · Meiji Jingu · hotel reset · Skytree",
    status: "current",
    ...
    dessert: [
      ...
      maps("Shimokita Chaen Oyama", "Shimokita Chaen Oyama"),
    ],
    timeline: [
      {
        label: "Before lunch",
      ...
      },
      {
        label: "After lunch",
        icon: "dessert",
        title: "Shimokita Chaen Oyama",
        description: "Japanese tea specialist at reload. The café counter runs from 2:00–6:00 PM.",
        links: [maps("Open in Maps", "Shimokita Chaen Oyama")],
      },
      {
        label: "After lunch",
        icon: "walk",
